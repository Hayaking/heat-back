...
public class HexUtil{
	...
	public static String crc16(byte[] bytes) {
        String[] zero ={"0000","000","00","0",""};
		int crc = 0xFFFF;
        for (byte b : bytes) {
            crc = (crc >>> 8) ^ table[(crc ^ b) & 0xff];
        }
		String crcStr = Integer.toHexString(crc);
		return zero[crcStr.length()]+crcStr;
    }
	...
	public static float hexStrToFloat(String hexStr) {
		//���ModBusЭ����ֽ���任
		hexStr = hexStr.substring(4,8) + hexStr.substring(0,4);
	...
	public static String floatToHexStr(float f) {
	    ...
	    return hexStr.substring(4,8) + hexStr.substring(0,4);
	}

	public static String bytesToString(byte[] bytes){
		return hba.marshal(bytes) ;
	}

	public static byte[] stringToBytes(String s){
		return hba.unmarshal(s);
	}

	public static String hexToASCII(String s){
		return new String(HexUtil.stringToBytes(s));
	}
